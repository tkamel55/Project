...
public class EditVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        idPos = idIntent ;
        myPhotoUrl = urlPhotoIntent ;
        myVideoUrl = urlVideoIntent ;
        ...
        edtDesc.setText(descIntent) ;
        edtTitle.setText(titleIntent) ;
        duration = durationIntent  ;
        tvDuration.setText("Duration : " + formatDuration(Long.parseLong(duration) ) );

        btnSetPicture = findViewById(R.id.btnEditThumbnail) ;
        btnSetPicture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CropImage.activity().start(EditVideoActivity.this);
            }
        });
        ...
        btnAddVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(EditVideoActivity.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
                    if (ActivityCompat.shouldShowRequestPermissionRationale(EditVideoActivity.this,
                            Manifest.permission.READ_EXTERNAL_STORAGE)){
                        ActivityCompat.requestPermissions(EditVideoActivity.this,
    ...
    void upload(final String title,final String desc){
        ...
        if (imageUri == null && videoUri == null ){
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("CategoryVideo").child(idCategoryIntent).child("List") ;
        ...
        else if (videoUri != null)
        {
            ...
            final StorageReference filereference = storageReference.child(idCategoryIntent).child("url_photo").child(idPos + ".png" );
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        final StorageReference videoreference = storageReference.child(idCategoryIntent).child("url_video").child(idPos + ".mp4" );
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode== OTHER_REQ &&resultCode== RESULT_OK){
            ...
            tvDuration.setText("Durasi : " + formatDuration(durationUriOfVideo(namePath)) );
